...
export default function NotFound() {
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center text-center p-8">
      <h1 className="text-5xl font-bold mb-6" style={{ color: 'var(--accent-color)' }}>404</h1>
      ...
      <Link href="/lifelog/bookshelf" className="px-6 py-3 rounded font-mono transition-colors" style={{ backgroundColor: 'var(--accent-color)', color: 'white' }}>Back to Bookshelf</Link>
    </div>
  );
}
