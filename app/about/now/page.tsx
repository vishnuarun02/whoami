export default function Now() {
  return (
    <div className="font-body p-4 md:p-6">
      ...
      <p className="mb-4 text-foreground">Here's what I'm currently focused on:</p>
      <ul className="list-disc pl-6 mb-6 space-y-2 text-foreground">
        ...
        <li>Assitant Manager @ GW Lerner's</li>
        <li>Building DocFlix with most amazing team mates!</li>
        <li>Searching for a Full Time Job!</li>
      </ul>
      <p className="mb-6 text-muted-foreground">Last updated: Feb 8, 2025</p>
