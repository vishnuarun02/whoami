  ...
  return (
    <div className="font-body p-4 md:p-6">
      ...
      <div className="flex flex-wrap gap-2 mt-6">
        <span className="bg-primary text-text px-2 py-1 rounded-full text-sm">Technology</span>
        <span className="bg-secondary text-text px-2 py-1 rounded-full text-sm">Creativity</span>
        <span className="bg-purple text-background px-2 py-1 rounded-full text-sm">Innovation</span>
      </div>
    </div>
  )
}
